...
CREATE TABLE `borrow`  (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  INDEX `f_bid`(`FineId`) USING BTREE,
...
INSERT INTO `reader` VALUES (3, '小红', '计科202', 'X@x.com', 20.90, '123456');
